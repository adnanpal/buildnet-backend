...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fields: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::author.author'
...
export interface ApiConnectionRequestConnectionRequest
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fromUser: Schema.Attribute.Relation<'manyToOne', 'api::app-user.app-user'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::connection-request.connection-request'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    toUser: Schema.Attribute.Relation<'manyToOne', 'api::app-user.app-user'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProfileProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    degree: Schema.Attribute.Enumeration<
      ['BSC_CS', 'BTECH_CSE', 'BTECH_IT', 'BE_CS', 'MSC_CS', 'MTECH_CSE']
    >;
    fullname: Schema.Attribute.String;
    levelofexperience: Schema.Attribute.Enumeration<
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    yearofstudy: Schema.Attribute.Enumeration<
      [
        'FIRST_YEAR',
        'SECOND_YEAR',
        'THIRD_YEAR',
